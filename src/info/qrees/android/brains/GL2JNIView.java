...
class GL2JNIView extends GLSurfaceView {
    ...
    public GL2JNIView(Context context, AssetManager assets) {
        super(context);
        _assets = assets;
        init(false, 0, 0);
    }

    public GL2JNIView(Context context, AssetManager assets, boolean translucent, int depth, int stencil) {
        super(context);
        _assets = assets;
    ...
    private static void checkEglError(String prompt, EGL10 egl) {
        ...
        while ((error = egl.eglGetError()) != EGL10.EGL_SUCCESS) {
            Log.w(String.format("%s: EGL error: 0x%x", prompt, error));
        }
    }
